      ...
      >
        <motion.div
          className={`${styles.content__container} ${
            isOpen ? styles.content__container__open : ''
          }`}
        ...
        >
          ...
          >
            ...
            >
              {title}
              {isOpen ? <Tags tags={tags} color={color} /> : null}
              <motion.div
            ...
            >
              <motion.path
                ...
                animate={{
                  ...
                  fill: fillSVG && !isOpen ? 'white' : 'transparent',
                }}
                fill="transparent"
                transition={{
                  duration: 0.6,
