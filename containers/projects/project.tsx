...
const Project = ({ title, image, technologies, color, aligned }: Props) => {
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{ rotateY, rotateX, backgroundColor: color }}
        whileHover={{
      ...
      >
        ...
        >
          <motion.div className={styles.text__title}>{title}</motion.div>
          <motion.div className={styles.text__technologies}>
            {technologies}
          </motion.div>
          <CodeAndLiveButtons color={color} />
        </motion.div>
        <motion.div
          ...
          } ${isWide ? styles.image__container__wide : ''} ${
          ...
          >
            ...
            <motion.path
              ...
              animate={{
                ...
                stroke: isSVGButtonHovered ? color : 'white',
              }}
              transition={{
                duration: 0.6,
              }}
            ...
            <motion.path
              ...
              animate={{
                ...
                fill: isSVGButtonHovered ? color : 'white',
              }}
              transition={{
                duration: 0.6,
              }}
